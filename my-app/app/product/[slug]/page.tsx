...
interface ProductsPageProps {
  products?: Product[];  // Le ? ici rend 'products' optionnel
}

export default function ProductsPage({ products = [] }: ProductsPageProps) {  // Défault value is an empty array
  ...
  if (products.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-xl text-gray-500">Aucun produit disponible</p>
      </div>
    );
  }
