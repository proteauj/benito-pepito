...
const BUFFER = 12;  // Buffer avant + après pour DOM léger
/* ========================================== */
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const result = await res.json(); // Type: unknown

        // Transformer en Product[] en vérifiant que c'est bien un tableau
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      window.requestAnimationFrame(() => {
        ...
        // Charger les éléments suivants si proche du bas
        if (scrollTop + clientHeight >= scrollHeight - 200 &&
            start + VISIBLE < filteredProducts.length) {
