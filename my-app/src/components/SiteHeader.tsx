      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href="/" className="h-16 flex items-center px-4 text-2xl md:text-3xl font-extrabold text-[var(--gold)] hover:bg-white hover:text-[var(--leaf)] transition-colors whitespace-nowrap">Benito Pepito</Link>
          </div>
          ...
          <div className="flex items-center space-x-2 h-16">
            {/* Mobile hamburger */}
            <button
              className="md:hidden h-16 w-16 text-[var(--gold)] hover:bg-white hover:text-[var(--leaf)] flex items-center justify-center transition-colors"
